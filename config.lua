...
Config.TimeToFarmSarap     = 2  * 1000 -- Saniyede kaç tane üzüm toplansın?
Config.TimeToProcessSarap  = 2  * 1000 -- Saniyede kaç tane şarap işlensin?
...
--	MelonDealer =		{x=-2197.04, y=4285.55, z=48.17}, -- KARPUZ SATMA YERİ
	SarapField = {x=356.23, y=6465.87, z=30.25-0.95}, -- ŞARAP TOPLAMA YERİ
	SarapProcessing =	{x=1389.04, y=3605.25, z=38.94-0.95}, -- ŞARAP İŞLEME YERİ
